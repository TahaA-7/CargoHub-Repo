...
class clientsCRUDTest(TestCase):
    ...
    # def test_verify_put(self):
        get_response = self.client.get(f'/api/clients/9998/', format='json')
        self.assertEqual(get_response.data["address"], "This is an updated test description.")
